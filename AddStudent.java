...
public class AddStudent extends JFrame implements ActionListener {
    ...
    JLabel labelrollno;
    JDateChooser dcdob;
    JComboBox<TeacherLeaveDetails> cbcourse, cbbranch;
    ...
    AddStudent(){  
        ...
        backgroundPanel.setBackground(new Color(204,204,246)); // Purple background
        ...
        backgroundPanel.add(lblrollno);
        
        labelrollno = new JLabel("1533"+first4);
        labelrollno.setBounds(200, 200, 200, 30);
        labelrollno.setFont(new Font("serif", Font.BOLD, 20));
        backgroundPanel.add(labelrollno);
        
        JLabel lbldob = new JLabel("Date of Birth");
        lbldob.setBounds(400, 200, 200, 30);
        lbldob.setFont(new Font("serif", Font.BOLD, 20));
        backgroundPanel.add(lbldob);
        
        dcdob = new JDateChooser();
        dcdob.setBounds(600, 200, 150, 30);
        backgroundPanel.add(dcdob);
        ...
        backgroundPanel.add(lblcourse);
        
        String course[] = {"B.Tech", "BBA", "BCA", "Bsc", "Msc", "MBA", "MCA", "MCom", "MA", "BA"};
        cbcourse = new JComboBox(course);
        cbcourse.setBounds(200, 400, 150, 30);
        cbcourse.setBackground(Color.WHITE);
        backgroundPanel.add(cbcourse);
