...
public class StudentFeeForm<E> extends JFrame implements ActionListener {

    Choice crollno;
    JComboBox<E> cbcourse, cbbranch, cbsemester;
    JLabel labeltotal;
    ...
    StudentFeeForm() {
        ...
        String course[] = {"BTech", "Bcom", "BCA", "Bsc", "Msc", "MBA", "MCA", "Mcom"};
