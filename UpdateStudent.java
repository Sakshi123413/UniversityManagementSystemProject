...
public class UpdateStudent extends JFrame implements ActionListener{
    ...
    JTextField tfcourse, tfaddress, tfphone, tfemail, tfbranch,tfx;
    JLabel labelrollno;
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update student set address='"+address+"', phone='"+phone+"', email='"+email+"',course='"+course+"', branch='"+branch+"', class_x='"+class_x+"' where rollno='"+rollno+"'";
                Conn con = new Conn();
